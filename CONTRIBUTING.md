...
Also the [known issues and suggestions](https://github.com/Gikunjuu/claude-beacon/issues/22): it tracks proposed enhancements, and anything marked in scope there is open to pick up.
...
```bash
./build.sh          # -> build/ClaudeBeacon.app
